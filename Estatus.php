                  ...
                  <?php if ($factura= ListaFacturacion($db,$sql)): ?>
                    <?php foreach($factura as $linea): ?>
                      <tr id="<?= $count+=1; ?>" name="linea">
                        ...
                        <td><input type="text" name="estado" class="form-control form-control-sm fw-bold <?= $linea['estado_id']==2 ? 'bg-danger': 'bg-success' ?> " value="<?= $linea['estado_id']==2 ? 'Con Omiso': 'Sin Omiso' ?> " disabled readonly required></td>
